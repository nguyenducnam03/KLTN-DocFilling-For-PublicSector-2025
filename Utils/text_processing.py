...
class Text_Processing:
    ...
    def get_modifed_tagname(self, contextual, label_llm, index_llm):
        ...
        if userX is None or value_tagname is None:
            if "kính gửi" in sentence_contextual:
                return "[receiver]"
            return tagname

        # Check if tagname is in list_cccd_passport_tagnames(Seen Fieldname)
    ...
    def fill_input_by_llm_form(self, form_llm_filled, input_form, process_tagname=True):
        ...
        # print(len(label_llm), len(label_input),22222222222222)
        # List tagname
        ...
        # print(tagname_for_input,22222222222)
        # print(copy_contextual_input,33333333333)
        # Fill
