...
Các tagname:
- Họ: [userX_surname]
- Chữ đệm: [userX_middle_name]
- Chữ đệm + Tên: [user1_middle_and_last_name]
- Tên riêng: [userX_first_name]
...
Ví dụ điền:
```
Họ: [user1_surname], Chữ đệm và tên: [user1_middle_and_last_name]
```
...
Ví dụ điền:
```
Họ: [user1_surname] Chữ đệm: [user1_middle_name] Tên: [user1_first_name]
```
...
### 6. Tóm tắt cách phân biệt hometown, permanent_address, current_address
- Hometown (quê quán):
...
Ví dụ điền:
```
Số điện thoại: [user1_phone_number]
```
...
- Nếu biểu mẫu yêu cầu thông tin về bảo hiểm y tế, có thể cân nhắc sử dụng `[user1_health_insurance_number]`.  
